(function(React) {
  ...
  const useScreenshotStore = create((set) => ({
    ...
    updateAnnotation: (id, updates) => set((s) => ({
      annotations: s.annotations.map((a2) => a2.id === id ? { ...a2, ...updates } : a2)
    })),
    bringToFront: (id) => set((s) => {
      const item = s.annotations.find((a2) => a2.id === id);
      if (!item) return s;
      return {
        annotations: [...s.annotations.filter((a2) => a2.id !== id), item]
      };
    }),
    removeAnnotation: (id) => set((s) => ({ annotations: s.annotations.filter((a2) => a2.id !== id) })),
    clearAnnotations: () => set({ annotations: [] }),
    setExportFormat: (exportFormat) => set({ exportFormat }),
    setQuickSaveSlots: (quickSaveSlots) => set({ quickSaveSlots }),
    resetScreenshot: () => set({ ...initialState })
  }));
  const useAppStore$1 = window.useAppStore;
  const LOUPE_SIZE = 140;
  const LOUPE_ZOOM = 4;
  const Loupe = React.memo(({ mouseX, mouseY, imageRef }) => {
    const loupeCanvasRef = React.useRef(null);
    React.useEffect(() => {
      ...
      ctx.clearRect(0, 0, LOUPE_SIZE * dpr2, LOUPE_SIZE * dpr2);
      ctx.save();
      ctx.beginPath();
      ctx.arc(LOUPE_SIZE * dpr2 / 2, LOUPE_SIZE * dpr2 / 2, LOUPE_SIZE * dpr2 / 2, 0, Math.PI * 2);
      ctx.clip();
      ctx.drawImage(
        sourceCanvas,
        (mouseX - sampleRadius) * dpr2,
        (mouseY - sampleRadius) * dpr2,
        sampleRadius * 2 * dpr2,
        sampleRadius * 2 * dpr2,
        0,
        0,
      ...
      ctx.lineWidth = 1;
      const center = LOUPE_SIZE * dpr2 / 2;
      ctx.beginPath();
      ctx.moveTo(center, 0);
      ctx.lineTo(center, LOUPE_SIZE * dpr2);
      ctx.moveTo(0, center);
      ctx.lineTo(LOUPE_SIZE * dpr2, center);
      ctx.stroke();
      ctx.strokeStyle = "rgba(244, 161, 37, 0.9)";
      ctx.lineWidth = 3 * dpr2;
      ctx.beginPath();
      ctx.arc(center, center, LOUPE_SIZE * dpr2 / 2 - 2 * dpr2, 0, Math.PI * 2);
      ctx.stroke();
  ...
  const CaptureToolbar = React.memo(({ mode, onModeChange, onCancel }) => {
    const t = useAppStore$1((s) => s.t);
    const modes = [
    ...
    return /* @__PURE__ */ window.React.createElement(
      ...
      modes.map((m2) => /* @__PURE__ */ window.React.createElement(
        "button",
        {
          key: m2.key,
          onMouseDown: (e) => e.stopPropagation(),
          ...
          style: {
            ...
            background: mode === m2.key ? "rgba(244, 161, 37, 0.25)" : "transparent",
            color: mode === m2.key ? "#f4a125" : "rgba(255, 255, 255, 0.7)"
          }
        },
  ...
  const DimensionLabel = React.memo(({ x: x2, y, width, height }) => {
  ...
  const ScreenshotOverlay = () => {
    ...
    const [selCoords, setSelCoords] = React.useState(null);
    ...
    React.useEffect(() => {
      ...
      captures.forEach((c2) => {
        if (c2.bounds.x < minX) minX = c2.bounds.x;
        if (c2.bounds.y < minY) minY = c2.bounds.y;
        if (c2.bounds.x + c2.bounds.width > maxX) maxX = c2.bounds.x + c2.bounds.width;
        if (c2.bounds.y + c2.bounds.height > maxY) maxY = c2.bounds.y + c2.bounds.height;
      });
    ...
    const handleMouseMove = React.useCallback((e) => {
      ...
      if (isDragging && selCoords) {
        setSelCoords(
          (prev) => prev ? { ...prev, currentX: e.clientX, currentY: e.clientY } : null
        );
      }
    ...
    const handleMouseUp = React.useCallback(() => {
      ...
      const h2 = Math.abs(selCoords.currentY - selCoords.startY);
      if (w < 10 || h2 < 10) {
        setSelCoords(null);
        return;
      }
    ...
    const cropAndTransition = React.useCallback((x2, y, w, h2) => {
      ...
      setSelection({ startX: x2, startY: y, endX: x2 + w, endY: y + h2 });
      setPhase("editing");
    ...
    return /* @__PURE__ */ window.React.createElement(
      ...
      captureMode === "region" && /* @__PURE__ */ window.React.createElement(
        "div",
        {
          style: {
            position: "absolute",
      ...
      selRect && selRect.width > 0 && selRect.height > 0 && /* @__PURE__ */ window.React.createElement(
        "div",
        {
          style: {
            position: "fixed",
      ...
      isDragging && captureMode === "region" && /* @__PURE__ */ window.React.createElement(
        Loupe,
        {
          mouseX: mousePos.x,
          mouseY: mousePos.y,
      ...
      /* @__PURE__ */ window.React.createElement("div", { style: { position: "fixed", bottom: 10, left: 10, zIndex: 999999, background: "rgba(0,0,0,0.8)", color: "lime", padding: 8, fontSize: 12, fontFamily: "monospace" } }, "Total Captures: ", captures.length, /* @__PURE__ */ window.React.createElement("br", null), "Image Lengths: ", captures.map((c2) => c2.imageDataUrl.length).join(", "), /* @__PURE__ */ window.React.createElement("br", null), "Canvas Size: ", backgroundCanvasRef.current ? `${backgroundCanvasRef.current.width}x${backgroundCanvasRef.current.height}` : "null"),
      renderActionButtons()
    );
  };
...
`;
  ...
  const OBJECT_ARRAY = "[object Array]", OBJECT_NUMBER = "[object Number]", OBJECT_STRING = "[object String]", OBJECT_BOOLEAN = "[object Boolean]", PI_OVER_DEG180 = Math.PI / 180, DEG180_OVER_PI = 180 / Math.PI, HASH = "#", EMPTY_STRING$1 = "", ZERO = "0", KONVA_WARNING = "Konva warning: ", KONVA_ERROR = "Konva error: ", RGB_PAREN = "rgb(", COLORS$1 = {
  ...
  const Util = {
    ...
    isCanvasFarblingActive() {
      ...
      for (let i2 = 0; i2 < 100; i2++) {
        if (d[i2 * 4] !== 40 || d[i2 * 4 + 1] !== 40 || d[i2 * 4 + 2] !== 40 || d[i2 * 4 + 3] !== 255) {
          isFarbling = true;
          break;
        }
      }
    ...
    getHitColorKey(r, g, b2) {
      if (this.isCanvasFarblingActive()) {
        r = Math.round(r / 5) * 5;
        g = Math.round(g / 5) * 5;
        b2 = Math.round(b2 / 5) * 5;
      }
      return HASH + this._rgbToHex(r, g, b2);
    },
    ...
    _namedColorToRBA(str) {
      const c2 = COLORS$1[str.toLowerCase()];
      if (!c2) {
        return null;
      }
      return {
  ...
  class Context {
    ...
    setTransform(a2, b2, c2, d, e, f) {
      this._context.setTransform(a2, b2, c2, d, e, f);
    }
    stroke(path2d) {
      if (path2d) {
    ...
    transform(a2, b2, c2, d, e, f) {
      this._context.transform(a2, b2, c2, d, e, f);
    }
    translate(x2, y) {
  ...
  let Arrow$1 = class Arrow extends Line$1 {
    _sceneFunc(ctx) {
  ...
  let Image$2 = class Image2 extends Shape {
    constructor(attrs) {
      super(attrs);
      this._loadListener = () => {
        this._requestDraw();
  ...
  Image$2.prototype._attrsAffectingSize = ["image"];
  _registerNode(Image$2);
  Factory.addGetterSetter(Image$2, "cornerRadius", 0, getNumberOrArrayOfNumbersValidator(4));
  ...
  function getSnap(snaps, newRotationRad, tol) {
    ...
    for (let i2 = 0; i2 < snaps.length; i2++) {
      const angle = Konva$1.getAngle(snaps[i2]);
  ...
  let Transformer$1 = class Transformer extends Group {
    constructor(config) {
      super(config);
    ...
    (function(module) {
      module.exports = function($$$config) {
        ...
        function pushHostContainer(fiber, nextRootInstance) {
          ...
          fiber = getRootHostContext2(nextRootInstance);
        ...
        function pushHostContext(fiber) {
          ...
          var context = contextStackCursor.current, nextContext = getChildHostContext2(context, fiber.type);
          context !== nextContext && (push(contextFiberStackCursor, fiber), push(contextStackCursor, nextContext));
        }
        function popHostContext(fiber) {
          contextFiberStackCursor.current === fiber && (pop(contextStackCursor), pop(contextFiberStackCursor));
          hostTransitionProviderCursor.current === fiber && (pop(hostTransitionProviderCursor), isPrimaryRenderer2 ? HostTransitionContext2._currentValue = NotPendingTransition2 : HostTransitionContext2._currentValue2 = NotPendingTransition2);
        }
        ...
        function prepareToHydrateHostInstance(fiber, hostContext) {
          if (!supportsHydration2) throw Error(formatProdErrorMessage(175));
          hydrateInstance(
            fiber.stateNode,
            fiber.type,
            fiber.memoizedProps,
        ...
        function popHydrationState(fiber) {
          ...
          if (13 === tag) {
            if (!supportsHydration2) throw Error(formatProdErrorMessage(316));
        ...
        function resetHydrationState() {
          supportsHydration2 && (nextHydratableInstance = hydrationParentFiber = null, isHydrating = false);
        }
        ...
        function pushProvider(providerFiber, context, nextValue) {
          isPrimaryRenderer2 ? (push(valueCursor, context._currentValue), context._currentValue = nextValue) : (push(valueCursor, context._currentValue2), context._currentValue2 = nextValue);
        }
        function popProvider(context) {
          var currentValue = valueCursor.current;
          isPrimaryRenderer2 ? context._currentValue = currentValue : context._currentValue2 = currentValue;
          pop(valueCursor);
        }
        ...
        function startTransition(fiber, queue, pendingState, finishedState, callback) {
          ...
          try {
            ...
            setCurrentUpdatePriority2(previousPriority), null !== prevTransition && null !== currentTransition.types && (prevTransition.types = currentTransition.types), ReactSharedInternals.T = prevTransition;
          }
        }
        ...
        function updateActivityComponent(current, workInProgress2, renderLanes2) {
          ...
          if (null !== prevState) {
            ...
            if (didSuspend)
              ...
              current = prevState.treeContext, supportsHydration2 && (nextHydratableInstance = getFirstHydratableChildWithinActivityInstance(dehydrated), hydrationParentFiber = workInProgress2, isHydrating = true, hydrationErrors = null, rootOrSingletonContext = false, null !== current && restoreSuspendedTreeContext(workInProgress2, current)), workInProgress2 = mountActivityChildren(workInProgress2, nextProps), workInProgress2.flags |= 4096;
        ...
        function updateSuspenseComponent(current, workInProgress2, renderLanes2) {
          ...
          if (null !== prevState && (nextPrimaryChildren = prevState.dehydrated, null !== nextPrimaryChildren)) {
            if (didSuspend)
              ...
              isSuspenseInstancePending(nextPrimaryChildren) ? (workInProgress2.flags |= 192, workInProgress2.child = current.child, workInProgress2 = null) : (current = prevState.treeContext, supportsHydration2 && (nextHydratableInstance = getFirstHydratableChildWithinSuspenseInstance(
                nextPrimaryChildren
          ...
          if (showFallback)
            return reuseSuspenseHandlerOnStack(), nextPrimaryChildren = nextProps.fallback, showFallback = workInProgress2.mode, prevState = current.child, didSuspend = prevState.sibling, nextProps = createWorkInProgress(prevState, {
              ...
              renderLanes2,
              null
            ), nextPrimaryChildren.flags |= 2), nextPrimaryChildren.return = workInProgress2, nextProps.return = workInProgress2, nextProps.sibling = nextPrimaryChildren, workInProgress2.child = nextProps, bailoutOffscreenComponent(null, nextProps), nextProps = workInProgress2.child, nextPrimaryChildren = current.child.memoizedState, null === nextPrimaryChildren ? nextPrimaryChildren = mountSuspenseOffscreenState(renderLanes2) : (showFallback = nextPrimaryChildren.cachePool, null !== showFallback ? (prevState = isPrimaryRenderer2 ? CacheContext._currentValue : CacheContext._currentValue2, showFallback = showFallback.parent !== prevState ? { parent: prevState, pool: prevState } : showFallback) : showFallback = getSuspendedCache(), nextPrimaryChildren = {
          ...
          switch (workInProgress2.tag) {
            ...
            case 3:
              a: {
                ...
                if (supportsHydration2 && $$typeof.isDehydrated)
                  if ($$typeof = {
                    element: nextProps,
                    isDehydrated: false,
            ...
            case 5:
              ...
              shouldSetTextContent2($$typeof, nextProps) ? props = null : null !== nextState && shouldSetTextContent2($$typeof, nextState) && (workInProgress2.flags |= 32);
              null !== workInProgress2.memoizedState && ($$typeof = renderWithHooks(
                ...
                null,
                renderLanes2
              ), isPrimaryRenderer2 ? HostTransitionContext2._currentValue = $$typeof : HostTransitionContext2._currentValue2 = $$typeof);
              markRef(current, workInProgress2);
        ...
        function updateHostContainer(current, workInProgress2) {
          if (supportsPersistence2 && doesRequireClone(current, workInProgress2)) {
        ...
        function updateHostComponent(current, workInProgress2, type, newProps) {
          if (supportsMutation2)
            ...
            if ((current = doesRequireClone(current, workInProgress2)) || oldProps$88 !== newProps) {
              ...
              oldProps$88 === currentInstance ? workInProgress2.stateNode = currentInstance : (markCloned(workInProgress2), finalizeInitialChildren2(
                oldProps$88,
                type,
                newProps,
                currentHostContext
        ...
        function preloadInstanceAndSuspendIfNeeded(workInProgress2, type, oldProps, newProps, renderLanes2) {
          if (0 !== (workInProgress2.mode & 32) && (null === oldProps ? maySuspendCommit2(type, newProps) : maySuspendCommitOnUpdate(type, oldProps, newProps))) {
          ...
          switch (workInProgress2.tag) {
            ...
            case 26:
              if (supportsResources) {
                ...
                null === current ? (markUpdate(workInProgress2), null !== nextResource ? (bubbleProperties(workInProgress2), preloadResourceAndSuspendIfNeeded(
                  ...
                  workInProgress2,
                  nextResource
                )) : (bubbleProperties(workInProgress2), workInProgress2.flags &= -16777217) : (nextResource = current.memoizedProps, supportsMutation2 ? nextResource !== newProps && markUpdate(workInProgress2) : updateHostComponent(
                  current,
                  workInProgress2,
                  type,
                  newProps
            ...
            case 27:
              if (supportsSingletons) {
                ...
                if (null !== current && null != workInProgress2.stateNode)
                  supportsMutation2 ? current.memoizedProps !== newProps && markUpdate(workInProgress2) : updateHostComponent(current, workInProgress2, type, newProps);
                else {
                  if (!newProps) {
                    if (null === workInProgress2.stateNode)
            ...
            case 5:
              ...
              if (null !== current && null != workInProgress2.stateNode)
                ...
                if (popHydrationState(workInProgress2))
                  ...
                  var instance$101 = createInstance2(
                    type,
                    newProps,
                    rootInstanceStackCursor.current,
                    nextResource,
            ...
            case 6:
              if (current && null != workInProgress2.stateNode)
                renderLanes2 = current.memoizedProps, supportsMutation2 ? renderLanes2 !== newProps && markUpdate(workInProgress2) : supportsPersistence2 && (renderLanes2 !== newProps ? (current = rootInstanceStackCursor.current, renderLanes2 = contextStackCursor.current, markCloned(workInProgress2), workInProgress2.stateNode = createTextInstance2(
                  newProps,
                  current,
                  renderLanes2,
                  workInProgress2
                ...
                if (popHydrationState(workInProgress2)) {
                  if (!supportsHydration2) throw Error(formatProdErrorMessage(176));
                  current = workInProgress2.stateNode;
              ...
              if (null === current || null !== current.memoizedState) {
                ...
                if (null !== renderLanes2) {
                  if (null === current) {
                    ...
                    if (!supportsHydration2) throw Error(formatProdErrorMessage(556));
            ...
            case 13:
              ...
              if (null === current || null !== current.memoizedState && null !== current.memoizedState.dehydrated) {
                ...
                if (null !== newProps && null !== newProps.dehydrated) {
                  if (null === current) {
                    ...
                    if (!supportsHydration2) throw Error(formatProdErrorMessage(344));
              ...
              return null;
            case 4:
              return popHostContainer(), updateHostContainer(current, workInProgress2), null === current && preparePortalMount2(workInProgress2.stateNode.containerInfo), bubbleProperties(workInProgress2), null;
            case 10:
          ...
          try {
            ...
            if (null !== ref) {
              switch (current.tag) {
                ...
                case 27:
                case 5:
                  var instanceToUse = getPublicInstance2(current.stateNode);
                  break;
                case 30:
        ...
        function commitHostMount(finishedWork) {
          ...
          try {
            commitMount2(instance, type, props, finishedWork);
          } catch (error) {
            captureCommitPhaseError(finishedWork, finishedWork.return, error);
          }
        }
              ...
              for (; null !== nextEffect; ) {
                ...
                switch (root.tag) {
                  ...
                  case 1:
                    ...
                    break;
                  case 3:
                    0 !== (firstChild & 1024) && supportsMutation2 && clearContainer2(root.stateNode.containerInfo);
                    break;
                  case 5:
                  case 26:
                  case 27:
              ...
              if (flags & 64 && (flags = finishedWork.updateQueue, null !== flags)) {
                ...
                if (null !== finishedWork.child)
                  switch (finishedWork.child.tag) {
                    case 27:
                    case 5:
                      finishedRoot = getPublicInstance2(finishedWork.child.stateNode);
                      break;
                    case 1:
          ...
          switch (finishedWork.tag) {
            ...
            case 5:
              ...
              if (supportsMutation2) {
                if (finishedWork.flags & 32) {
                  ...
                  try {
                    resetTextContent2(hoistableRoot);
                  } catch (error) {
                    captureCommitPhaseError(finishedWork, finishedWork.return, error);
                  }
                }
            ...
            case 6:
              ...
              if (flags & 4 && supportsMutation2) {
                ...
                hoistableRoot = finishedWork.stateNode;
                try {
                  commitTextUpdate2(hoistableRoot, current, flags);
                } catch (error) {
                  captureCommitPhaseError(finishedWork, finishedWork.return, error);
                }
              }
            ...
            case 3:
              ...
              commitReconciliationEffects(finishedWork);
              if (flags & 4) {
                if (supportsMutation2 && supportsHydration2 && null !== current && current.memoizedState.isDehydrated)
                  try {
            ...
            case 22:
              ...
              commitReconciliationEffects(finishedWork);
              if (flags & 8192 && (root = finishedWork.stateNode, root._visibility = hoistableRoot ? root._visibility & -2 : root._visibility | 1, hoistableRoot && (null === current || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || recursivelyTraverseDisappearLayoutEffects(finishedWork)), supportsMutation2)) {
                a: if (current = null, supportsMutation2)
                  for (root = finishedWork; ; ) {
                    if (5 === root.tag || supportsResources && 26 === root.tag) {
                      if (null === current) {
                        wasHidden = current = root;
                        try {
                          newResource = wasHidden.stateNode, hoistableRoot ? hideInstance2(newResource) : unhideInstance2(
                            wasHidden.stateNode,
                      ...
                      if (null === current) {
                        ...
                        try {
                          ...
                          hoistableRoot ? hideTextInstance2(instance) : unhideTextInstance2(instance, wasHidden.memoizedProps);
                        } catch (error) {
                          captureCommitPhaseError(wasHidden, wasHidden.return, error);
                        }
                      }
              ...
              if (supportsMutation2) {
                ...
                switch (hostParentFiber.tag) {
                  ...
                  case 5:
                    ...
                    hostParentFiber.flags & 32 && (resetTextContent2(parent$125), hostParentFiber.flags &= -33);
        ...
        function requestUpdateLane() {
          return 0 !== (executionContext & 2) && 0 !== workInProgressRootRenderLanes ? workInProgressRootRenderLanes & -workInProgressRootRenderLanes : null !== ReactSharedInternals.T ? requestTransitionLane() : resolveUpdatePriority2();
        }
              ...
              if (2 === exitStatus) {
                ...
                if (0 !== JSCompiler_inline_result) {
                  ...
                  a: {
                    ...
                    var wasRootDehydrated = supportsHydration2 && root.current.memoizedState.isDehydrated;
        ...
        function commitRootWhenReady(root, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
          ...
          if (suspendedCommitReason & 8192 || 16785408 === (suspendedCommitReason & 16785408)) {
            suspendedCommitReason = startSuspendingCommit2();
            accumulateSuspenseyCommitOnFiber(
              finishedWork,
              lanes,
            ...
            timeoutOffset = waitForCommitToBeReady2(
              suspendedCommitReason,
              timeoutOffset
            );
        ...
        function flushMutationEffects() {
          if (1 === pendingEffectsStatus) {
            ...
            if (0 !== (finishedWork.subtreeFlags & 13878) || rootMutationHasEffect) {
              ...
              executionContext |= 4;
              try {
                commitMutationEffectsOnFiber(finishedWork, root), resetAfterCommit2(root.containerInfo);
              } finally {
        ...
        function flushSpawnedWork() {
          if (4 === pendingEffectsStatus || 3 === pendingEffectsStatus) {
            ...
            if (null !== recoverableErrors) {
              ...
              remainingLanes = getCurrentUpdatePriority2();
              setCurrentUpdatePriority2(2);
              ReactSharedInternals.T = null;
              try {
                ...
                ReactSharedInternals.T = finishedWork, setCurrentUpdatePriority2(remainingLanes);
              }
            }
        ...
        exports$1.discreteUpdates = function(fn, a2, b2, c2, d) {
          ...
          try {
            ...
            setCurrentUpdatePriority2(previousPriority), ReactSharedInternals.T = prevTransition, 0 === executionContext && (workInProgressRootRenderTargetTime = now2() + 500);
          }
        };
        ...
        exports$1.flushSyncFromReconciler = function(fn) {
          ...
          try {
            ...
            setCurrentUpdatePriority2(previousPriority), ReactSharedInternals.T = prevTransition, executionContext = prevExecutionContext, 0 === (executionContext & 6) && flushSyncWorkAcrossRoots_impl(0);
          }
        };
...
`;
  ...
  const a = /* @__PURE__ */ l(/* @__PURE__ */ React__namespace.createContext(null));
  class m extends React__namespace.Component {
    render() {
      return /* @__PURE__ */ React__namespace.createElement(a.Provider, { value: this._reactInternals }, this.props.children);
    }
  }
  function c() {
    const e = React__namespace.useContext(a);
    if (e === null) throw new Error("its-fine: useFiber must be called within a <FiberProvider />!");
    const t = React__namespace.useId();
  ...
  function h() {
    const e = c(), [t] = React__namespace.useState(() => /* @__PURE__ */ new Map());
    t.clear();
    let r = e;
    for (; r; ) {
      const n = r.type;
      b(n) && n !== a && !t.has(n) && t.set(n, React__namespace.use(l(n))), r = r.return;
    }
    return t;
  }
  function x() {
    ...
    return React__namespace.useMemo(
      () => Array.from(e.keys()).reduce(
        (t, r) => (n) => /* @__PURE__ */ React__namespace.createElement(t, null, /* @__PURE__ */ React__namespace.createElement(r.Provider, { ...n, value: e.get(r) })),
        (t) => /* @__PURE__ */ React__namespace.createElement(m, { ...t })
      ),
      [e]
    );
  }
  ...
  const EditorToolbar = React.memo(({
    ...
    return /* @__PURE__ */ window.React.createElement(
      ...
      TOOLS.map((tool) => /* @__PURE__ */ window.React.createElement(
        "button",
        {
          key: tool.key,
          onClick: () => onToolChange(tool.key),
          title: t(`ss${tool.key.charAt(0).toUpperCase() + tool.key.slice(1)}`),
          style: {
            display: "flex",
            alignItems: "center",
        ...
        /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 20, fontVariationSettings: "'FILL' 1" } }, tool.icon)
      )),
      /* @__PURE__ */ window.React.createElement("div", { style: { width: 1, height: 24, background: "rgba(255,255,255,0.12)", margin: "0 6px" } }),
      COLORS.map((c2) => /* @__PURE__ */ window.React.createElement(
        "button",
        {
          key: c2,
          onClick: () => onColorChange(c2),
          style: {
            width: 22,
            height: 22,
            borderRadius: "50%",
            border: activeColor === c2 ? "2px solid #f4a125" : "2px solid transparent",
            background: c2,
            cursor: "pointer",
            transition: "border-color 0.15s",
            boxShadow: activeColor === c2 ? "0 0 0 2px rgba(244,161,37,0.3)" : "none"
          }
        }
      )),
      /* @__PURE__ */ window.React.createElement("div", { style: { width: 1, height: 24, background: "rgba(255,255,255,0.12)", margin: "0 6px" } }),
      STROKE_WIDTHS.map((w) => /* @__PURE__ */ window.React.createElement(
        "button",
        {
          key: w,
      ...
      /* @__PURE__ */ window.React.createElement("div", { style: { width: 1, height: 24, background: "rgba(255,255,255,0.12)", margin: "0 6px" } }),
      /* @__PURE__ */ window.React.createElement("button", { onClick: onUndo, title: t("ssUndo"), style: {
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        width: 36,
      ...
      } }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 20 } }, "undo")),
      (activeTool === "rect" || activeTool === "circle") && /* @__PURE__ */ window.React.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 20 } }, isFilled ? "format_color_fill" : "border_style")
      ),
      /* @__PURE__ */ window.React.createElement("button", { onClick: onClear, title: t("ssClearAll"), style: {
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        width: 36,
        ...
        color: "#ff3366",
        marginLeft: 6
      } }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 20 } }, "delete_sweep")),
      /* @__PURE__ */ window.React.createElement("div", { style: { width: 1, height: 24, background: "rgba(255,255,255,0.1)", margin: "0 8px" } }),
      /* @__PURE__ */ window.React.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 22, fontVariationSettings: "'FILL' 0" } }, "frame_inspect")
      ),
      activeTool === "text" && /* @__PURE__ */ window.React.createElement("div", { style: { display: "flex", gap: 4, marginLeft: 8 } }, FONTS.map((f) => /* @__PURE__ */ window.React.createElement(
        "button",
        {
          key: f.name,
      ...
      /* @__PURE__ */ window.React.createElement("div", { style: { width: 1, height: 24, background: "rgba(244,161,37,0.25)", margin: "0 8px" } }),
      /* @__PURE__ */ window.React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } }, ["png", "jpg", "webp"].map((f) => /* @__PURE__ */ window.React.createElement(
        "button",
        {
          key: f,
        ...
        f
      )), /* @__PURE__ */ window.React.createElement("div", { style: { width: 1, height: 24, background: "rgba(255,255,255,0.12)", margin: "0 4px" } }), /* @__PURE__ */ window.React.createElement("button", { onClick: onCopy, style: {
        display: "flex",
        alignItems: "center",
        gap: 6,
        padding: "8px 14px",
        ...
        fontWeight: 500,
        transition: "all 0.2s"
      } }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 18, fontVariationSettings: "'FILL' 1" } }, "content_copy"), t("copy")), /* @__PURE__ */ window.React.createElement("button", { onClick: onSave, style: {
        display: "flex",
        alignItems: "center",
        gap: 6,
        padding: "8px 14px",
        ...
        fontWeight: 500,
        transition: "all 0.2s"
      } }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 18, fontVariationSettings: "'FILL' 1" } }, "save"), t("ssSave")), /* @__PURE__ */ window.React.createElement("div", { style: { width: 1, height: 24, background: "rgba(255,255,255,0.12)", margin: "0 4px" } }), /* @__PURE__ */ window.React.createElement("button", { onClick: onDone, style: {
        display: "flex",
        alignItems: "center",
        gap: 6,
        padding: "8px 16px",
        ...
        fontWeight: 600,
        transition: "all 0.2s"
      } }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined", style: { fontSize: 18, fontVariationSettings: "'FILL' 1" } }, "check_circle"), t("ssDone")))
    );
  });
  const AnnotationEditor = () => {
    ...
    const windowPosition = useScreenshotStore((s) => s.windowPosition);
    const [selectedShapeId, setSelectedShapeIdState] = React.useState(null);
    const setSelectedShapeId = React.useCallback((id) => {
    ...
    const [drawStartPos, setDrawStartPos] = React.useState(null);
    ...
    const [fontFamily, setFontFamily] = React.useState(FONTS[0].value);
    const [hasImageBorder, setHasImageBorder] = React.useState(false);
    const [imageBorderColor, setImageBorderColor] = React.useState(activeColor);
    const [isImageBorderSelected, setIsImageBorderSelected] = React.useState(false);
    ...
    const onToolChange = React.useCallback((tool) => {
      setActiveTool(tool);
      setSelectedShapeId(null);
      setIsImageBorderSelected(false);
    ...
    const handleStageMouseDown = React.useCallback((e) => {
      ...
      if (activeTool === "text" && !clickedOnEmpty) {
        ...
        const shape = annotations.find((a2) => a2.id === id);
    ...
    const handleStageMouseMove = React.useCallback((e) => {
      if (!isDrawing) return;
      const stage = e.target.getStage();
      const pointer = stage?.getPointerPosition();
      if (!pointer || !stage) return;
    ...
    const handleStageMouseUp = React.useCallback((e) => {
      if (e.evt.button === 1) {
        const stage2 = e.target.getStage();
        if (stage2) {
          stage2.stopDrag();
          stage2.draggable(false);
          stage2.container().style.cursor = activeTool === "select" ? "default" : activeTool === "text" ? "text" : "crosshair";
        }
        return;
      }
      ...
      if (activeTool === "pen" || activeTool === "highlighter") {
        ...
        const h2 = Math.abs(pos.y - drawStartPos.y);
        if (w > 3 && h2 > 3) {
          addAnnotation({
            id,
            tool: "rect",
    ...
    const getCompositeDataUrl = React.useCallback(async () => {
      const stage = stageRef.current;
    ...
    const handleCopy = React.useCallback(async () => {
      ...
      await window.api.clipboardWriteImage(base64Data);
    }, [getCompositeDataUrl]);
    const handleSave = React.useCallback(async () => {
      const dataUrl = await getCompositeDataUrl();
      if (!dataUrl) return;
      const base64Data = dataUrl.replace(/^data:image\/png;base64,/, "");
      await window.api.invoke("save-screenshot", base64Data);
    }, [getCompositeDataUrl]);
    const handleStartTextEdit = React.useCallback((shape) => {
      const id = shape.id;
    ...
    return /* @__PURE__ */ window.React.createElement(
      ...
      /* @__PURE__ */ window.React.createElement("div", { style: {
        ...
        /* @__PURE__ */ window.React.createElement(Layer, null, /* @__PURE__ */ window.React.createElement(
          Image$1,
          {
            image: bgImage,
            width: stageSize.width,
        ...
        ), hasImageBorder && /* @__PURE__ */ window.React.createElement(
          Rect,
          {
            x: 0,
            y: 0,
        ...
        /* @__PURE__ */ window.React.createElement(Layer, null, annotations.map((shape) => {
          switch (shape.tool) {
            case "pen":
            case "highlighter":
              return /* @__PURE__ */ window.React.createElement(
            ...
            case "rect":
              return /* @__PURE__ */ window.React.createElement(
                Rect,
                {
                  ...
                  height: shape.height,
                  stroke: shape.color,
                  fill: shape.isFilled ? shape.color : void 0,
                  strokeWidth: shape.strokeWidth,
                  draggable: activeTool === "select",
                  onClick: () => activeTool === "select" && setSelectedShapeId(shape.id)
                }
        ...
        }), isDrawing && (activeTool === "pen" || activeTool === "highlighter") && currentPoints.length >= 4 && /* @__PURE__ */ window.React.createElement(
          Line,
          {
            points: currentPoints,
            stroke: activeColor,
        ...
        ), isDrawing && activeTool === "arrow" && drawStartPos && currentMousePos && /* @__PURE__ */ window.React.createElement(
          Arrow,
          {
        ...
        ), isDrawing && activeTool === "rect" && drawStartPos && currentMousePos && /* @__PURE__ */ window.React.createElement(
          Rect,
          {
            ...
            stroke: activeColor,
            fill: isFilled ? activeColor : void 0,
            strokeWidth: activeStrokeWidth
          }
        ), isDrawing && activeTool === "circle" && drawStartPos && currentMousePos && /* @__PURE__ */ window.React.createElement(
          Circle,
          {
            x: drawStartPos.x,
            y: drawStartPos.y,
      ...
      ), textEntry && /* @__PURE__ */ window.React.createElement("div", { style: {
        position: "absolute",
  ...
  const PluginRoot = () => {
    ...
    return /* @__PURE__ */ window.React.createElement(React.Fragment, null, /* @__PURE__ */ window.React.createElement(ScreenshotOverlay, null), /* @__PURE__ */ window.React.createElement(AnnotationEditor, null));
  };
